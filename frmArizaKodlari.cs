    ...
    public partial class frmArizaKodlari : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            if (btnKaydet.Text=="KAYDET" && txtArizaKodu.Text!="" && cmbBolum.SelectedIndex != -1)
            {
                ...
                sqCom.CommandText =
                    "INSERT INTO bakArizaKodlari (ArizaKodu, Tur, Pasif) VALUES (@ArizaKodu, @Tur, @Pasif)";
            ...
            else if (btnKaydet.Text=="GÜNCELLE")
            {
                if (btnKaydet.Text=="GÜNCELLE" && txtArizaKodu.Text !="" && cmbBolum.SelectedIndex != -1)
                {
                    if (!String.IsNullOrEmpty(ArizaKoduid.Text))
                    {
                        ...
                        sqCom.Connection = sqlConn;
                        sqCom.CommandText =
                            "UPDATE bakArizaKodlari SET ArizaKodu=@ArizaKodu, Tur=@Tur, Pasif=@Pasif WHERE ArizaKoduID =" +
                            ArizaKoduid.Text;
        ...
        private void veriListele()
        {
            ...
            sqCom.CommandText =
                "SELECT Tbl1.ArizaKoduID, Tbl1.ArizaKodu, Tbl2.Turu, Tbl1.Pasif FROM bakArizaKodlari Tbl1 LEFT JOIN bakTur Tbl2 ON Tbl1.Tur=Tbl2.TurID";
            sqCom.ExecuteNonQuery();
        ...
        private void dataGridView1_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.Rows.Count > 0)
                {
                    ...
                    sqCom.CommandText =
                        "SELECT Tbl1.ArizaKoduID, Tbl1.ArizaKodu, Tbl2.Turu, Tbl1.Pasif FROM bakArizaKodlari Tbl1 LEFT JOIN bakTur Tbl2 ON Tbl1.Tur=Tbl2.TurID WHERE ArizaKoduID =" +
                        ArizaKoduid.Text;
                    sqCom.ExecuteNonQuery();
